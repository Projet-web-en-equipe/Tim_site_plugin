...
var posExtreme = 50;
//ancienne valeur de la distance entre 2 doigts
var exDistance = null;
...
window.addEventListener("touchmove", (e) => {
  ...
  if (!leCanvas.lock) {
    ...
    posX = touch.clientX;
    posY = touch.clientY;
    //detecte les multiples doigts sur l'ecran
    var doigts = e.touches || e.changedTouches;
    //si les extremites x du canvas sortent de la page + un margin posExtreme
    if (leCanvas.html.getBoundingClientRect().x <= posExtreme || leCanvas.html.getBoundingClientRect().x + leCanvas.html.getBoundingClientRect().width >= window.innerWidth - posExtreme) {
...
//fonction pour trouver distance entre 2 doigts
